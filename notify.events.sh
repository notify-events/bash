...
print_help() {
  ...
  echo "--text        required param to specify message text (allowed html tags: <b>, <i>, <a>, <br>)"
  echo "--title       message title"
  echo "--priority    message priority (available values: highest, high, normal, low, lowest. Default: normal)"
  echo "--level       message level (available values: verbose, info, notice, warning, error, success. Default: info)"
